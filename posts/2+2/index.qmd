...
::: {.sidebar-note }
So, you probably notice that GPT2 has given you a nonsensical answer. As mentioned earlier, GPT2 is more of an autocompletion engine than its successors which actually have the ability to process instructions. I'd chosen the problem 2+2 for this article believing that 2+2=4 would be such a common pattern in any training data set, that I could keep focus on environmental impact, allowing numerous other articles to show much better examples of where AI can get wrong answers. Apparently, the training data for many early models – I tried many besides GPT2 – don't have enough examples of 2+2=4 to divulge that exact answer when prompted. Go figure!
:::
